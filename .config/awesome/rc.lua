...
local term_scratch = bling.module.scratchpad {
    ...
    geometry = {x=960 - 360, y=540 - 240, width=720, height=480}, -- The geometry in a floating state
...
beautiful.init("/home/junk/.config/awesome/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, opacity = 0 })
...
globalkeys = gears.table.join(
    ...
    --My bindings
    awful.key({ modkey, "Shift"   }, "b", function () awful.spawn("librewolf") end,
              {description = "open a qutebrowser", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "m", function () awful.spawn("thunderbird") end,
              {description = "open a thunderbird", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "d", function () awful.spawn("discord") end,
              {description = "open discord", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "z", function () awful.spawn("zathura") end,
              {description = "open zathura", group = "launcher"}),
    ...
    -- Run rofi launcher
    awful.key({modkey}, "p", function() awful.spawn.with_shell("rofi -show drun &") end, {description = "run rofi launcher", group = "launcher" }),

    -- Run rofi ssh
    awful.key({modkey, "Shift"}, "s", function() awful.spawn.with_shell("rofi -terminal alacritty -show ssh -window") end, {description = "run rofi ssh", group = "launcher" })
)
